...
1. Kirim formulir otorisasi pemeriksaan latar belakang kepada kandidat
   ...
   - Formulir harus mencakup:
     ...
     - Otorisasi untuk melakukan pemeriksaan kredit (jika berlaku untuk posisi tertentu)
     - Otorisasi untuk pemeriksaan catatan kriminal
...
â˜ Verifikasi Riwayat Pekerjaan
â˜ Pemeriksaan Catatan Kriminal
â˜ Verifikasi Kredensial Pendidikan
â˜ Pemeriksaan Referensi
â˜ Laporan Kredit (jika berlaku)
â˜ Penyaringan media sosial/online
...
Verifikasi Identitas: â˜ LULUS â˜ GAGAL â˜ TIDAK JELAS
Riwayat Pekerjaan: â˜ LULUS â˜ GAGAL â˜ TIDAK JELAS
Catatan Kriminal: â˜ LULUS â˜ GAGAL â˜ TIDAK JELAS
Kredensial Pendidikan: â˜ LULUS â˜ GAGAL â˜ TIDAK JELAS
Referensi: â˜ LULUS â˜ GAGAL â˜ TIDAK JELAS


REKOMENDASI KESELURUHAN: 
â˜ DISETUJUI - Disetujui untuk direkrut
â˜ BERSYARAT - Tinjauan lebih lanjut diperlukan
â˜ DITOLAK - Jangan rekrut
...
â˜ Email/Kotak surat dinonaktifkan
â˜ Akses VPN dicabut
â˜ Akses database dihapus
â˜ Akun aplikasi cloud dinonaktifkan
â˜ Akses berbagi file dicabut
â˜ Kartu akses bangunan dinonaktifkan
â˜ Sistem lainnya: ____________________________
...
â˜ Monitor/Periferal
â˜ Telepon seluler
â˜ Lencana/kunci akses
â˜ Drive USB/media seluler
â˜ Dokumen yang berisi info perusahaan
â˜ Peralatan lainnya


VERIFIKASI AKHIR:
â˜ Semua akses sistem diverifikasi dicabut
â˜ Akses fisik diverifikasi dinonaktifkan
â˜ Semua peralatan sepenuhnya diperhitungkan
â˜ File dimigrasi/diarsipkan
â˜ Wawancara keluar diselesaikan
â˜ Tidak ada properti perusahaan yang tersisa
...
-----|----------|-----------|----------
Laptop | _____ | _____ | â˜
Monitor | _____ | _____ | â˜
Mouse/KB | _____ | _____ | â˜
Telepon | _____ | _____ | â˜
Lencana | _____ | _____ | â˜
Kunci | _____ | _____ | â˜
